...
#pragma parameter C_BLK_LVL "Black Level" 0.03 -0.2 0.2 0.01
...
#pragma parameter MICRO_AO "Depth: Cavity AO Power" 0.7 0.0 2.0 0.05
#pragma parameter AO_SKIN_PROT "Depth: AO Skin Protect" 0.60 0.0 1.0 0.05
#pragma parameter FRESNEL_INT "Light: Fresnel Intensity" 0.2 0.0 2.0 0.05
#pragma parameter RIM_LIGHT "Light: Rim Intensity" 0.2 0.0 2.0 0.05
#pragma parameter RIM_MASK_POWER "Light: Rim Mask Threshold" 1.0 0.0 3.0 0.1
#pragma parameter SPEC_STR "Light: Specular Intensity" 0.3 0.0 2.0 0.05
#pragma parameter DIR_BIAS "Light: Dir Bias" 0.2 -1.0 1.0 0.05

// [البارات الموحدة الجديدة للتحكم الذكي في لون الظلال والحواف]
#pragma parameter AO_TINT_SEL "AO Shadow Color: Purple->Dark->Warm" 0.2 0.0 1.0 0.05
#pragma parameter RIM_TINT_SEL "Rim Light Color: Ice->White->Gold" 0.2 0.0 1.0 0.05
...
#pragma parameter VIBRANCE "Color: Vibrance" 1.2 -1.0 2.0 0.10
#pragma parameter WARMTH "Color: Warmth" 0.2 -0.50 0.50 0.05
#pragma parameter AMBIENT_INJECT "ACES: Ambient Injection" 0.1 0.0 1.0 0.05
...
uniform float C_BLK_LVL, C_WHT_LVL, dither_str, OUTLINE_STR, MICRO_AO, AO_SKIN_PROT, FRESNEL_INT, RIM_LIGHT, RIM_MASK_POWER, SPEC_STR, DIR_BIAS, LUMA_ADAPT, HIGH_COMP, VIBRANCE, WARMTH, AMBIENT_INJECT;
