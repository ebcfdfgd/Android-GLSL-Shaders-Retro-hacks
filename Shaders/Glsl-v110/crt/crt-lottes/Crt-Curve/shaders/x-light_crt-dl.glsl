...
uniform float BARREL_DISTORTION, BRIGHT_BOOST, VIG_STR, hardScan, SCAN_STR, mask_dark, mask_light, MASK_W;
#endif
...
void main() {
    ...
    // 4. LOTTES SCANLINES (FIXED & STABILIZED)
    // التعديل: حساب المسافة بناءً على بكسلات اللعبة الصافية قبل الانحناء لضمان الثبات
