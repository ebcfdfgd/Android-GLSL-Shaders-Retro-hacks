...
// Final Version: Analog Noise Integration + Smart Dither
...
#ifdef PARAMETER_UNIFORM
uniform float ntsc_hue, COL_BLEED, red_persistence, rb_power, rb_size, rb_detect, rb_speed, rb_tilt, ntsc_blur, analog_noise, tv_mist;
#else
...
// دالة نويز تناظري عالية الجودة تعتمد على بذور متغيرة
