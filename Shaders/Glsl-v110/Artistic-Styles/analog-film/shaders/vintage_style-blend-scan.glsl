...
// ===== Vintage - Master Theme Hue (Controls All Tints Harmoniously) =====
...
void main() {
    ...
    // ============================================================
    // Dynamic Procedural Split Tone (Driven by Master Hue)
    // ============================================================
    // 1. Light Leak: Direct Master Hue
    vec3 leakColor = hue2rgb(vt_theme_hue);

    // 2. Highlights: Slightly shifted Hue for natural warmth
    vec3 highlightTint = hue2rgb(fract(vt_theme_hue + 0.05)) * 0.20;

    // 3. Shadows: Complementary Hue (+0.50) for cinematic contrast
