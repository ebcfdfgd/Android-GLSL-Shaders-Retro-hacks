...
uniform float BARREL_DISTORTION, BRIGHT_BOOST, v_amount, MASK_TYPE, MASK_STR, MASK_W, MASK_H, SCAN_STR, SCAN_DENS, BLOOM_INT, BLOOM_TH;
#endif
...
void main() {
    ...
    // 7. BLOOM (Luma Thresholding)
    // نطبق البلوم بعد الماسك والاسكان عشان يسيح عليهم
