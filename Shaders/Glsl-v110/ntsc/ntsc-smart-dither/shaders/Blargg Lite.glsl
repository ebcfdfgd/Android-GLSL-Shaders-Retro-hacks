...
/* Blargg Ultra-Lite (Final Precise Build + Signal RF Grain & Jailbars)
   - Added: Signal RF Grain (60-Series) with Smart Bypass.
...
// دالة الـ Hash الأصلية لـ RF Grain
float hash(vec2 co) {
...
void main() {
    ...
    // --- 4. ARTIFACTS: JAILBARS & SIGNAL RF GRAIN (SMART BYPASS) ---
    // تم التعديل هنا ليكون العرض ثابتاً ومستقلاً عن الدقة
