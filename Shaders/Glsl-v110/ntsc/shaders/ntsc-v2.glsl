/* 777-NTSC-MD-PRO-TURBO-V3
    ...
    - ADDED: Global Saturation & Black Level Control.
*/
...
uniform float SATURATION, BLACK_LEVEL, rb_power, rb_size, rb_slant, rb_detect, rb_speed, rb_phase, rb_sat;
...
void main() {
    ...
    if (sig_noise > 0.0) {
    // استخدام عملية ضرب بسيطة بدلاً من الدوال المعقدة
    float n = fract(uv.x * uv.y * time * 1000.0);
    y += (n - 0.5) * sig_noise;
}
    ...
    // 6. Hue Rotation, Saturation & RGB Assembly
    ...
    // 7. Final Black Level Adjustment
