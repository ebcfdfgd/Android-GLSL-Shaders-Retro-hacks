/* --- NTSC MEGA LITE (TURBO OPTIMIZED + FIXED PRECISION) ---
   ...
   - OPTIMIZED: Mist and Jitter removed for better performance.
*/
...
uniform float ntsc_blur, rb_opacity, rb_zoom, rb_speed, rb_tilt, rb_sat, red_persistence, NOISE_STR, COL_BLEED, horiz_sharp;
