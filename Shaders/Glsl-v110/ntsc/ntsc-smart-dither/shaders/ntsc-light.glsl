...
/* NTSC-ULTRA-CLEAN (G90T Stable Edition)
    - Fix: Unified all calculations in Fragment for stability.
    - Logic: Pure Manual Mode with Pattern-Based Blur.
    - Performance: Reduced texture fetches to the absolute minimum.
*/
