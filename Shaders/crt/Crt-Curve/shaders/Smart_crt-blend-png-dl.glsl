...
uniform float BARREL_DISTORTION, BRIGHT_BOOST, v_amount, hardScan, SCAN_STR, SCAN_THRESH, MASK_LIGHT, MASK_DARK, LUTWidth2, LUTHeight2;
#endif
...
void main() {
    ...
    // 4. Smart Scanlines (Adaptive Blooming)
