// --- NTSC ADAPTIVE-ULTIMATE (113 Logic + RF Grain & Jailbars Build) ---
#version 110
...
void main() {
    ...
    if (ntsc_blur <= 0.0 && rb_power <= 0.0 && fr_str <= 0.0 && bleed_str <= 0.0 && red_persistence <= 0.0 && sig_noise <= 0.0 && jail_str <= 0.0) {
