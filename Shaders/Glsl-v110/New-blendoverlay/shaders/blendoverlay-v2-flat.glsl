...
/* ULTIMATE-TURBO-300 (Performance Build - 5050 DNA)
   ...
   - CLEANED: Barrel Distortion and Vignette removed for maximum speed.
...
uniform float ZOOM, BRIGHT_BOOST, blend_mode, OverlayMix, LUTWidth, LUTHeight, blend_mode2, OverlayMix2, LUTWidth2, LUTHeight2;
#endif
...
void main() {
    // 1. حساب الإحداثيات مع الزووم فقط
    vec2 uv = (TEX0.xy - 0.5) / ZOOM + 0.5;

    // [B] محرك الشرب السريع (Quilez Scaling - 5050 Logic)
    ...
    // 6. تطبيق الـ Boost النهائي والخرج
