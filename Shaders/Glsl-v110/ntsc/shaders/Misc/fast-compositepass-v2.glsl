/*
    ...
    - Feature: Integrated Signal RF Grain & Vertical Jailbars (Smart Bypass).
...
void main()
{
    ...
    // التعديل: التردد ثابت الآن ومستقل عن دقة الشاشة
    if (JAIL_STR > 0.0) {
        res += sin(TEX0.x * JAIL_WIDTH * 500.0) * JAIL_STR * 0.05;
    }
