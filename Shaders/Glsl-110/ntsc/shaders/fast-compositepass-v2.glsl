...
/*
    ...
    - Performance: No loops, direct matrix multiplication.
*/
...
void main()
{
    ...
    // تحويل المركز والجوانب إلى فضاء YIQ
    vec3 c_m = res * RGB_to_YIQ;
    
    // سحب عينات أبعد قليلاً لنزيف لوني أوضح
    ...
    // استخدام معادلة الفرق المركزي للحدة
