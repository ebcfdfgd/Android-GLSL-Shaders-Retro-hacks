/*
    NTSC Shader - Ultra Optimized (Hue, Sharpness, Sat, Black & RF Grain Build)
    ...
    - Added: Global Saturation and Black Level control.
    - Smart Bypass: RF Grain enabled only when > 0.
*/
...
void main()
{
    ...
    // --- COLOR PROCESSING (YIQ: Hue & Saturation) ---
    ...
    vec2 rotated_IQ;
    // Apply Rotation for Hue and Multiplication for Saturation
    ...
    // --- FINAL ADJUSTMENTS (Black Level & Clamp) ---
    Cur_Local = mix(vec3(BLACK_LEVEL), vec3(1.0), Cur_Local);
