...
void main()
{
    ...
    // --- ARTIFACTS: JAILBARS & RF GRAIN (Smart Bypass) ---
    // Updated: Resolution independent jailbar spacing
    if (jail_str > 0.0) res += sin(TEX0.x * jail_width * 500.0) * jail_str * 0.02;
