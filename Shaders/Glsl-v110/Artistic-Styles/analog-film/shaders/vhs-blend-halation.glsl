...
/*
    VHS Signal & Degradation Shader with Blend & Recycled Halation (RetroArch GLSL)
    ------------------------------------------------------------------------------
*/
...
void main() {
    ...
    // ========================================================
    // 3. SGPT Edge Smoothing Blend & Recycled Halation
    // ========================================================
    ...
    // Halation effect reusing the L and R blend samples (0 additional texture fetches)
    if (HALATION_STR > 0.0) {
        vec3 halo_sample = (L + R) * 0.5;
