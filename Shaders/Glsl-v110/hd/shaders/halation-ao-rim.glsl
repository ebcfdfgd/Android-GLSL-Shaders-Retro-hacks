...
void main() {
    ...
    // [2] HALATION CALCULATION (Uses 4 cardinal directions)
    ...
    // [3] OUTLINE & EDGE (Uses 4 cardinal directions)
    ...
    // [4] LIGHTING & AO (Uses 4 cardinal directions)
    ...
    // Rim Light (Linked to the 4-direction edge)
