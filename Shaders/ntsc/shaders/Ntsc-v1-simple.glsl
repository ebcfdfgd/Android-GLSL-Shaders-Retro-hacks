/* 777-NTSC-V1-TURBO-SATURATION-GRAIN
   - ADDED: High-Precision RF Grain (from 16).
   - ADDED: Saturation Control (Chroma scaling).
   - ADDED: Black Level Control.
   - OPTIMIZED: High-Precision Hash logic.
*/
...
uniform float COL_BLEED, red_persistence, rb_power, rb_size, rb_detect, rb_speed, rb_tilt, de_dither, SATURATION, BLACK_LEVEL, sig_noise;
#endif
