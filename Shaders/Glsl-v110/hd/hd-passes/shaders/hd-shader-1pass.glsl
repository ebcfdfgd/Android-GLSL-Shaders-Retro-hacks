...
uniform float BLOOM_STR,SOFT_BLOOM,SHARPEN_STR,BLACK_LEVEL,HIGHLIGHT_COMP,WARMTH_STR,TINT_STR;
uniform float OUTLINE_STR,FLARE_STR,GODRAY_STR,TILTSHIFT_STR,MOTION_BLUR,COLOR_GRAD,DEPTH_MASK;
