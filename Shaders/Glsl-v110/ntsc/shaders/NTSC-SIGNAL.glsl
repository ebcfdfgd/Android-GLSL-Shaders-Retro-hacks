/* PHYSICAL-SIGNAL-EMULATOR-V21-SMOOTH-GRAIN
...
uniform float NTSC_FREQ, NTSC_SENSE, rb_tilt, ntsc_hue, COL_BLEED, de_dither, NTSC_SHARP, CRAWL_SPEED, NTSC_ARTIFACTS, NTSC_SATURATION;
