...
void main() {
    ...
    // 2. FIXED SCANLINES
    // الحساب المباشر بناء على ارتفاع التكستشر لضمان ثبات الخطوط
    ...
    // 4. Bloom (Luma Thresholding)
    // حساب السطوع واضافة التوهج للمناطق الساطعة فقط
