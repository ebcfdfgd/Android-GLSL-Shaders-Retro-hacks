/* 777-LITE-TURBO-V4-FLAT-QUILEZ-BLOOM
    ...
    - ADDED: Luma-based Bloom (Single-Pass).
*/
...
uniform float BRIGHT_BOOST, SCAN_STR, SCAN_SIZE, MASK_STR, MASK_W, BLOOM_INT, BLOOM_TH;
#endif
...
void main() {
    ...
    // [2] FIXED SCANLINES (ربط مباشر بالبكسلات الاصلية)
    // الحساب يتم مباشرة على محور Y الخاص بالصورة الاصلية
    ...
    // [4] BLOOM (توهج المناطق الساطعة)
    // حساب السطوع واضافة التوهج للمناطق التي تتجاوز حد العتبة
