...
/* 777-NTSC-MEGA-LITE-PASS1 (NTSC CORE)
    - Pass 1: Handles De-Dithering, Chroma Bleeding, and Rainbow Effects.
*/
...
uniform float COL_BLEED, rb_power, rb_size, rb_detect, rb_speed, rb_tilt, de_dither;
#endif
