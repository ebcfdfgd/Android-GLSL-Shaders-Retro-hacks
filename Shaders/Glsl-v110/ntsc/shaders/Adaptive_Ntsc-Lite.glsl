// --- NTSC ADAPTIVE-ULTIMATE (Luma Dither Blur + Persistence Edition) ---
...
void main() {
    ...
    // تم إضافة red_persistence للشرط لضمان عملها عند تفعيلها
    if (dither_blur <= 0.0 && rb_power <= 0.0 && fr_str <= 0.0 && bleed_str <= 0.0 && red_persistence <= 0.0) {
    ...
    // تطبيق سيلان الأحمر: سحب الكروما من اليسار لليمين
