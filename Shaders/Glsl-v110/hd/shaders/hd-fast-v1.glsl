...
#pragma parameter C_WHT_LVL "White Level" 0.95 0.0 1.5 0.01
...
#pragma parameter RIM_LIGHT "Light: Rim Strength" 1.75 0.0 2.0 0.05
#pragma parameter RIM_MASK_POWER "Rim Mask Threshold" 0.5 0.0 3.0 0.1
...
#pragma parameter VIBRANCE "Color: Vibrance" 1.0 -1.0 2.0 0.05
#pragma parameter WARMTH "Color: Warmth" 0.2 -0.50 1.50 0.05
...
uniform float C_BLK_LVL,C_WHT_LVL,dither_str, OUTLINE_STR, MICRO_AO, AO_SKIN_PROT, RIM_LIGHT, RIM_MASK_POWER, VIBRANCE, WARMTH,  HIGH_COMP, LUMA_ADAPT;
