/* ULTIMATE SONIC 2026 - PURE NATURAL (ULTRA-LIGHT GAMMA EDITION) */
...
uniform float GAMMA_BOOST, C_BLK_LVL, C_WHT_LVL, OUTLINE_STR, MICRO_AO, RIM_LIGHT, SPEC_STR, VIBRANCE, WARMTH, LUMA_ADAPT;
...
void main() {
    ...
    // [1] PURE CENTER PIXEL (No Dither Blending)
    ...
    // Fast hardware-friendly Gamma approximation (No sqrt, No mix)
