...
/* 777-CRT-ANALOG-MASTER (2-TAP ULTRA-FAST: BLOOM + HALATION)
    - 2 FETCHES ONLY: 1 Main Pixel + 1 Offset Sample.
    - INCLUDES: Central Bloom & Red/Orange CRT Halation tint.
    - OPTIMIZED: Maximum possible performance.
*/
