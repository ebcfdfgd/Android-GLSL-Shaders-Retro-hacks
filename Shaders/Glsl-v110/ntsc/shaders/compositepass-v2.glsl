// --- NTSC-ULTIMATE-PERSISTENCE (Hue & Sharp Build + RF Grain) ---
...
// - Added: Signal RF Grain (Exact 60)
...
uniform float ntsc_res, ntsc_hue, SATURATION, BLACK_LEVEL, ntsc_sharp, fring, afacts;
