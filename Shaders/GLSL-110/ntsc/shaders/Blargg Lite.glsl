/* Blargg Ultra-Lite (131-Genesis Precision Build)
    ...
    - Optimization: Full Bypass on Zero Settings (إيقاف كامل للسحب)
*/
...
#ifdef PARAMETER_UNIFORM
uniform float ntsc_hue, ntsc_res, ntsc_sharp, fring, afacts, COL_BLEED, rb_power, dot_crawl, de_dither, pi_mod, vert_scal;
#endif
...
void main() {
    ...
    // --- 2. CONDITIONAL SMART FETCHES (إيقاف كامل للسحب لو القيمة صفر) ---
    // الاكتشاف والدمج والتدخل يعتمدون الآن بالكامل على وجود قيمة أكبر من صفر
