...
uniform float BRIGHT_BOOST, hardScan, SCAN_STR, SCAN_THRESH, MASK_STRENGTH, MASK_W;
#endif
...
void main() {
    ...
    // حساب الماسك الأساسي
    vec3 mcol = 2.0 - abs(pos * 6.0 - vec3(1.0, 3.0, 5.0));
    // دمج الماسك باستخدام القوة المختارة
    res *= mix(vec3(1.0), clamp(mcol, 0.0, 1.0), MASK_STRENGTH);
