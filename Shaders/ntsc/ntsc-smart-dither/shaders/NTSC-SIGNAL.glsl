/* PHYSICAL-SIGNAL-EMULATOR-V21-SMART-DITHER-16-RED-FIX
   - Optimized for RetroArch Android - GLSL 110
   - ADDED: Red Persistence (Red Smear) logic
*/
...
#pragma parameter red_persistence "Red Persistence" 1.0 0.0 2.5 0.05
...
uniform float NTSC_FREQ, NTSC_SENSE, rb_tilt, ntsc_hue, COL_BLEED, red_persistence, ntsc_blur, CRAWL_SPEED, NTSC_ARTIFACTS, NTSC_SATURATION;
...
void main() {
    ...
    // نقوم بخلط القناة I (الأحمر/سيلان) مع العينة السابقة لخلق تأثير الذيل
