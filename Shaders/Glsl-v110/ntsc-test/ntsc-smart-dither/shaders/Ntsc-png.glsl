...
// --- NTSC MEGA LITE (TURBO OPTIMIZED + ARTIFACTS) ---
...
void main() {
    ...
    if(JAIL_STR > 0.0) final_y += sin(uv.x * TextureSize.x * JAIL_WIDTH) * JAIL_STR * 0.05;

    // 6. Final RGB Assembly
    vec3 result = vec3(
