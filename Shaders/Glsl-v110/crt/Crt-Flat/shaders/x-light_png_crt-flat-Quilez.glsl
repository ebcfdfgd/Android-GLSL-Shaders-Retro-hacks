/* ULTIMATE-TURBO-HYBRID-FLAT-QUILEZ-BLOOM
...
uniform float BRIGHT_BOOST, MASK_TYPE, MASK_STR, MASK_W, MASK_H, SCAN_STR, SCAN_DENS, BLOOM_INT, BLOOM_TH;
#endif
...
void main() {
    ...
    // 2. FIXED SCANLINES
    // الحساب المباشر اعتماداً بـ ارتفاع الصورة لضمان ثبات الخطوط
