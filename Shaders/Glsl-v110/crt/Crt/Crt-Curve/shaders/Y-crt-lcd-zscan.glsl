...
/* 777-ULTRA-PURE-SCAN-V13-ZFAST-HYBRID
    - INTEGRATED: Advanced Zfast Scanline Engine (High/Low Luminance Weights).
    - INTEGRATED: Barrel Distortion from Shader 70.
...
void main() {
    // 1. Geometry (Barrel Distortion - Shader 70 Logic)
