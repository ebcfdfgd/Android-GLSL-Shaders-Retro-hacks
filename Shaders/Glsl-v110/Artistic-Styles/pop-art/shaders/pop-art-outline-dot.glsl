...
void main() {
    ...
    // ========================================================
    // 1. Calculate Posterized Palette Target
    // ========================================================
    ...
    // ========================================================
    // 2. Blend Original Colors + 4-Color Palette
    // ========================================================
    ...
    // ========================================================
    // 3. HUD Mask
    // Prevent outlines on bright elements / white HUD
    // ========================================================
    ...
    float wU = dot(abs(C - U), Y);
    float wD = dot(abs(C - D), Y);
