// --- NTSC ADAPTIVE-ULTIMATE (Blargg Ultra-Lite Final Build + RF Grain) ---
#version 110

/* Blargg Ultra-Lite (Final Precise Build + Signal RF Grain)
...
// Original RF Grain Hash function
float hash(vec2 co) {
...
void main() {
    ...
    // --- 4. ARTIFACTS: SIGNAL RF GRAIN (SMART BYPASS) ---
    if (sig_noise > 0.0) {
