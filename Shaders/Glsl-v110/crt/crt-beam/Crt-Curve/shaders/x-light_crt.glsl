...
// تم استبدال بارميتر hardScan ببارميتر SCAN_BEAM التفاعلي الجديد
uniform float BARREL_DISTORTION, BRIGHT_BOOST, VIG_STR, SCAN_STR, SCAN_BEAM, MASK_STR;
#endif

void main() {
    // 1. Coordinates & Curve (تأثير الكيرف سليم تماماً)
    ...
    // 4. DYNAMIC SCAN_BEAM INTEGRATION (تعديل نظام السكان فقط هنا)
