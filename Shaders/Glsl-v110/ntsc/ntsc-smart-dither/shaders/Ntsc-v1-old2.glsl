/* --- 777-NTSC-V1-TURBO-ULTRA-GRAIN (SMART DITHER 16 + SAT/BLACK) ---
    - REMOVED: Red Persistence & MD Vertical Jailbars.
...
uniform float SATURATION, BLACK_LEVEL, COL_BLEED, rb_power, rb_size, rb_detect, rb_speed, rb_tilt, ntsc_blur, sig_noise;
#endif
