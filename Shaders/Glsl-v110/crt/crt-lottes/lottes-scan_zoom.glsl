// PUBLIC DOMAIN CRT FAST-SCAN V2.3 - SCREEN-SPACE SCAN
// VERSION: GLSL 110 (Max Compatibility)
// MODES: 1 = Sony Trinitron, 2 = Slot Mask

#pragma parameter scanZoom "Scanline Cycle (Pixels)" 3.0 1.0 10.0 1.0
...
uniform float scanZoom, hardScan, hardPix, warpX, warpY, maskDark, maskLight, shadowMask, brightBoost, bloomAmount;
#else
#define scanZoom 3.0
#define hardScan -8.0
#define hardPix -3.0
...
void main() {
    ...
    // --- السكان لاين المعتمد على بكسلات الشاشة والزوم ---
    // gl_FragCoord.y تعطيك موقع البكسل الحقيقي على الشاشة
    float beam = fract(gl_FragCoord.y / scanZoom); 
