...
*/
#pragma parameter GAMMA_POW "Gamma Power (Pro)" 0.86 0.1 3.0 0.05
...
#pragma parameter COL_BLEED "Chroma Bleed Strength" 1.8 0.0 5.0 0.05
#pragma parameter rb_power "Rainbow Strength" 0.05 0.0 2.0 0.01
...
uniform float NTSC_BRIGHTNESS, SATURATION, COL_BLEED, rb_power, rb_size, rb_detect, rb_speed, rb_tilt, de_dither,GAMMA_POW;
#endif
...
// دالة المثلث السريعة جداً (Triangle Wave)
// تُستخدم بدلاً من sin/cos وتعمل بدورة معالجة واحدة فقط
...
void main() {
    ...
    if (rb_power > 0.0) {
        ...
        // استدعاء دالة المثلث بدلاً من sin/cos
