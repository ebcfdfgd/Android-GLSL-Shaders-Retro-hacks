...
/* ULTIMATE-TURBO-HYBRID (300 Engine - Optimized - Backported to 110)
    - Removed: Zoom Scale.
    - Feature: Toshiba Cylindrical Curve (Faster & Straight Edges).
    - Smart Branching: GPU skips unused Layers (Mask, Scanlines, Overlays).
*/
...
void main() {
    ...
    // كيرف توشيبا الأسطواني - فائق السرعة مع الحفاظ على الحواف
    ...
    // [B] Early Exit (توفير الطاقة للأجزاء خارج الشاشة)
    ...
    // [D] Smart Scanlines (لا يتم الحساب إلا إذا كانت القوة أكبر من صفر)
    if (SCAN_STR > 0.01) {
