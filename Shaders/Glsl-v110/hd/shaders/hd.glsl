...
#pragma parameter RIM_LIGHT "Light: Rim Strength" 0.15 0.0 2.0 0.05
...
#pragma parameter DEPTH_FADE "Engine: Depth Fade" 0.4 0.0 0.5 0.05
#pragma parameter LUMA_ADAPT "Engine: Luma Adaptation" 0.1 0.0 0.5 0.05
#pragma parameter HIGH_COMP "Engine: Highlight Comp" 0.2 0.0 1.0 0.1
...
#pragma parameter CINEMA_CONTRAST "ACES: Shadow Contrast" 1.2 1.00 2.0 0.05
...
uniform float DITHER_REM, OUTLINE_STR, MICRO_AO, AO_SKIN_PROT, RIM_LIGHT, RIM_MASK_POWER, SHARPEN_STR, BLOOM_STR, DEPTH_FADE, LUMA_ADAPT, HIGH_COMP, VIBRANCE, WARMTH,SPEC_STR,DIR_BIAS;
