...
#pragma parameter tv_mist "TV Signal Mist" 0.15 0.0 1.0 0.05
...
uniform float COL_BLEED, red_persistence, rb_power, rb_size, rb_detect, rb_speed, rb_tilt, de_dither, sig_noise, tv_mist;
#endif
...
void main() {
    ...
    final_y = mix(final_y, (yL + yM + yR) * 0.333, tv_mist * step(0.001, tv_mist));
