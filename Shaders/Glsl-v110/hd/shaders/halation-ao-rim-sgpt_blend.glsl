...
void main() {
    ...
    // [2] SGPT BLEND (Kept as is using C, L, R)
    ...
    // [3] HALATION CALCULATION (Using all 4 directions: L, R, U, D)
    ...
    // [5] LIGHTING & AO & RIM (Using all 4 directions)
