...
/* LIGHT-ULTIMATE (Clean Edition - DNA 5050)
    - OPTIMIZED: Removed all distortion and vignette math.
    - CORE: Quilez Scaling + Master Brightness Boost + Dual Multiply Blending + Zoom.
*/
...
uniform float ZOOM, BRIGHT_BOOST, OverlayMix, LUTWidth, LUTHeight, OverlayMix2, LUTWidth2, LUTHeight2;
#endif

void main() {
    // 1. Quilez Scaling (Base Image with Zoom)
    ...
    // Final Output (Boost applied here as Master Gain)
