...
void main() {
    ...
    // 3. SIGNAL PROCESSING (De-Dither OFF if 0.0)
    ...
    // 4. CHROMA & FRINGING (OFF if both 0.0)
    ...
    // 6. RAINBOW PNG & ARTIFACTS (OFF if Opacity and Artifacts are 0.0)
