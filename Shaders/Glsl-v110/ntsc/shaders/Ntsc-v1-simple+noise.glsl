...
#pragma parameter ntsc_grain "Analog Signal Noise" 0.04 0.0 1.0 0.02
...
uniform float NTSC_BRIGHTNESS, SATURATION, COL_BLEED, rb_power, rb_size, rb_detect, rb_speed, rb_tilt, de_dither , ntsc_grain;
#endif
