/* 777-NTSC-V1-TURBO-SATURATION-GRAIN
    - High-Precision RF Grain.
    - Saturation Control (Chroma scaling).
    - Black Level Control.
...
uniform float COL_BLEED, rb_power, rb_size, rb_detect, rb_speed, rb_tilt, de_dither, SATURATION, BLACK_LEVEL, sig_noise;
#endif
