/* NTSC-MD-PRO TURBO (FIXED: High Precision + Smooth Grain)
...
#ifdef GL_ES
// تم رفع الدقة لضمان عدم تكسر النويز
...
void main() {
    ...
    // RF Grain يعمل الآن بدقة عالية وبشكل ناعم (Boiling effect)
