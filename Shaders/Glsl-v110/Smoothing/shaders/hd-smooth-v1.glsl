...
uniform float HD_SMOOTH, DITHER_REM, SCAN_STR, EDGE_SHINE, OUTLINE_STR, MICRO_AO, AO_SKIN_PROT, RIM_LIGHT, RIM_MASK_POWER, BLOOM_STR, LUMA_ADAPT, HIGH_COMP, VIBRANCE, WARMTH, BLACK_DEPTH;
