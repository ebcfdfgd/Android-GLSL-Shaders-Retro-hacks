...
// --- NTSC ADAPTIVE-ULTIMATE (Enhanced with Analog Artifacts) ---
...
#pragma parameter JAIL_WIDTH "Jailbar Spacing" 1.5 0.5 5.0 0.1
...
void main() {
    ...
    if (ARTF_STR <= 0.0 && RAINBOW_STR <= 0.0 && CHROMA_BLEED <= 0.0 && red_persistence <= 0.0 && SHARPNESS <= 0.0 && NOISE_STR <= 0.0 && JAIL_STR <= 0.0) {
