/* ULTIMATE SONIC 2026 - NO DITHER VERSION */
...
uniform float C_BLK_LVL, C_WHT_LVL, OUTLINE_STR, MICRO_AO, AO_SKIN_PROT, RIM_LIGHT, RIM_MASK_POWER, SPEC_STR, DIR_BIAS, VIBRANCE, WARMTH, HIGH_COMP, LUMA_ADAPT;
